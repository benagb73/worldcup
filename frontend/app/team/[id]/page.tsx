...
function PositionGroup({ pos, players }: { pos: string; players: PlayerTournamentTotals[] }) {
  return (
    <div className="overflow-hidden rounded-2xl border border-white/10 panel">
      ...
      <div className="hidden sm:grid grid-cols-[40px_1fr_minmax(0,90px)_repeat(6,minmax(0,46px))] items-center gap-2 border-b border-white/5 bg-white/[0.02] px-4 py-2 text-[10px] font-bold tracking-widest text-cream/40">
